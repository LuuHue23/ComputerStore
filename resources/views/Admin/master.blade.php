      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('list')}}"><i class="fa fa-circle-o"></i> Danh sách tài khoản</a></li>
            <!-- <li><a href=""><i class="fa fa-circle-o"></i> Thêm mới tài khoản</a></li> -->
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('add_category')}}"><i class="fa fa-circle-o"></i> Thêm mới danh mục</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> Danh sách hóa đơn</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> Danh sách banner</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Thêm mới banner</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> Danh sách comment</a></li>
          </ul>
        </li>
        <li>
          <a href="">
